  ...
  return (
    <section className=" p-12 overflow-hidden">
      <div className="grid grid-cols-[1fr_2.5fr] gap-12 items-center">
        ...
        <div className="flex flex-col gap-6">
          <div>
            ...
            <p className="text-black text-sm leading-relaxed mb-6">
              Entrust your locks to our team of skilled and<br/> creative stylists
            </p>
          </div>
          <div className="flex items-center gap-3 mt-8">
            ...
            <button onClick={() => scroll("right")} className="m-2 hover:bg-black hover:text-white w-11 h-11 rounded-full border-2 border-gray-800 flex items-center justify-center cursor-pointer">
            <ArrowLeft/>
            </button>
            <button onClick={() => scroll("left")} className="hover:bg-black hover:text-white w-11 h-11 rounded-full border-2 border-gray-800 flex items-center justify-center cursor-pointer">
              <Arrow/>
            </button>
        ...
        <div ref={carouselRef} className="flex gap-5 overflow-x-hidden scroll-smooth pr-8 mask-r-from-50%">
          {team.map((member, i) => (
